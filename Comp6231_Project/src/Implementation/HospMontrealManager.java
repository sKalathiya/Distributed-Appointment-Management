...
public class HospMontrealManager {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            if(appointId.substring(0, 3).trim().equals(id.substring(0, 3).trim()))
            {
                if(appointId.substring(0, 3).trim().equals("MTL"))
                    result=generateJSONObject(id,appointId,appointType,capacity,Constants.NONE,Constants.NONE,Constants.ADD_OPERATION,m_data.addAppoint(appointId,appointType,capacity));
                else
    ...
    public String removeAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            {
                if(appointId.substring(0, 3).trim().equals("MTL"))
                    result=generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.REMOVE_OPERATION,m_data.removeAppoint(appointId, appointType));
                else
    ...
    public String listAppointAvailability(String id, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            result=m_data.retriveAppointment(appointType).trim();
            result+=requestOnServer(id,Constants.NONE,appointType,Constants.NONE,Constants.LOCAL_Quebec_PORT,Constants.LIST_OPERATION).trim();
    ...
    public String bookAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            {
                str.append(requestOnServer(id,appointId,Constants.NONE,Constants.NONE,Constants.LOCAL_Quebec_PORT,"countAppointment")+",");
            ...
            if(id.substring(0, 3).equals(appointId.substring(0, 3)))
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.BOOK_OPERATION,m_data.bookAppoint(id,appointId,appointType));
            }
    ...
    public String cancelAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            if(appointId.substring(0, 3).trim().equals(id.substring(0, 3).trim()))
            {
               return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.CANCEL_OPERATION,m_data.removeAppoint(id,appointId,appointType));
            }
            else if(id.substring(0, 3).equals("MTL"))
            {
    ...
    public String getBookingSchedule(String id)
    {
        ...
        str.append(requestOnServer(id,"No appoint id",Constants.NONE,Constants.NONE,Constants.LOCAL_Quebec_PORT,Constants.SCHEDULE_OPERATION).trim());
    ...
    private String swapAppointBooking(String id, String appointId, String appointType) {
        if(appointType.trim().equals("physician")||appointType.trim().equals("surgeon")||appointType.trim().equals("dental"))
        {
            ...
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.SWAP_OPERATION,m_data.bookAppoint(id,appointId,appointType));
            }
    ...
    private String swapCancelBooking(String id, String appointId, String appointType) {
        if(appointType.trim().equals("physician")||appointType.trim().equals("surgeon")||appointType.trim().equals("dental"))
        {
            if(id.substring(0, 3).trim().equals(appointId.substring(0, 3).trim()))
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.SWAP_OPERATION,m_data.removeAppoint(id,appointId,appointType));
            }
            else if(appointId.substring(0, 3).trim().equals("MTL"))
            {
                String msg="";
    ...
    private boolean checkExistingAppoint(String id, String appointId, String appointType) {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            {
                data=requestOnServer(id,appointId,Constants.NONE,Constants.NONE,Constants.LOCAL_Montreal_PORT,"existingAppointment");
                return data.equals("Denies")? false:true;
            }
            else if(appointId.substring(0, 3).equals("QUE"))
            {
                data=requestOnServer(id,appointId,Constants.NONE,Constants.NONE,Constants.LOCAL_Quebec_PORT,"existingAppointment");
                return data.equals("Denies")? false:true;
            }
            else if(appointId.substring(0, 3).equals("SHE"))
            {
                data=requestOnServer(id,appointId,Constants.NONE,Constants.NONE,Constants.LOCAL_Sherbrook_PORT,"existingAppointment");
                return data.equals("Denies")? false:true;
            }
            else
                return false;
