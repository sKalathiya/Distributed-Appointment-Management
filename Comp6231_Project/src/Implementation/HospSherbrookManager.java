...
public class HospSherbrookManager {
    ...
    public String addAppoint(String id, String appointId, String appointType, String capacity)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            {
                if(appointId.substring(0, 3).trim().equals("SHE"))
                    result=generateJSONObject(id,appointId,appointType,capacity,Constants.NONE,Constants.NONE,Constants.ADD_OPERATION,s_data.addAppoint(appointId,appointType,capacity));
                else
    ...
    public String removeAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            {
                if(appointId.substring(0, 3).trim().equals("SHE"))
                    result=generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.REMOVE_OPERATION,s_data.removeAppoint(appointId, appointType));
                else
    ...
    public String listAppointAvailability(String id, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            result=s_data.retriveAppointment(appointType).trim();
            ...
            result=result+requestOnServer(id,Constants.NONE,appointType,Constants.NONE,Constants.LOCAL_Quebec_PORT,Constants.LIST_OPERATION).trim();
    ...
    public String bookAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            ...
            if(id.substring(0, 3).equals(appointId.substring(0, 3)))
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.BOOK_OPERATION,s_data.bookAppoint(id,appointId,appointType));
            }
    ...
    public String cancelAppoint(String id, String appointId, String appointType)
    {
        ...
        if(appointType.equals("physician")||appointType.equals("surgeon")||appointType.equals("dental"))
        {
            if(appointId.substring(0, 3).trim().equals(id.substring(0, 3).trim()))
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.CANCEL_OPERATION,s_data.removeAppoint(id,appointId,appointType));
            }
            else if(id.substring(0, 3).equals("MTL"))
            {
    ...
    private String swapAppointBooking(String id, String appointId, String appointType) {
        if(appointType.trim().equals("physician")||appointType.trim().equals("surgeon")||appointType.trim().equals("dental"))
        {
            ...
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.SWAP_OPERATION,s_data.bookAppoint(id,appointId,appointType));
            }
    ...
    private String swapCancelBooking(String id, String appointId, String appointType) {
        if(appointType.trim().equals("physician")||appointType.trim().equals("surgeon")||appointType.trim().equals("dental"))
        {
            if(id.substring(0, 3).trim().equals(appointId.substring(0, 3).trim()))
            {
                return generateJSONObject(id,appointId,appointType,Constants.NONE,Constants.NONE,Constants.NONE,Constants.SWAP_OPERATION,s_data.removeAppoint(id,appointId,appointType));
            }
            else if(appointId.substring(0, 3).trim().equals("MTL"))
            {
                String msg="";
